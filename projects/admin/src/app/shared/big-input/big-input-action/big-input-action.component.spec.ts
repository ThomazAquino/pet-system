...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<pet-big-input-action></pet-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<pet-big-input-action [disabled]="true"></pet-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<pet-big-input-action fontSet="fas" fontIcon="fa-trash"></pet-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<pet-big-input-action label="delete"></pet-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<pet-big-input-action (action)="actionHandler()"></pet-big-input-action>';
    fixture = createHostComponent(template);
