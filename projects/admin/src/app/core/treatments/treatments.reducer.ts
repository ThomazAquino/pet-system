...
const reduce = createReducer(
  ...
  on(TreatmentsActions.loadTreatments, (state, action) =>
    adapter.addAll(action.treatments, state)
  ),
  on(TreatmentsActions.clearTreatments, (state) => adapter.removeAll(state))
);
